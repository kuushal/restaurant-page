export default function loadMenu() {
    ...
    menuHeadingTea.textContent = 'Honey Tea';
    menuCardTea.appendChild(menuHeadingTea);

    const paraTea = document.createElement('p');
    paraTea.classList.add('desc');
    paraTea.textContent = 'A warm, sweet tea made with the highest quality honey and a bit of lemon to start your day off right!';
